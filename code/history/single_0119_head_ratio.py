...
class MySingleStreamModel(nn.Module):
    def __init__(self, 
        ...
        self.head_gdm_ratio = make_head()
        self.head_clover_ratio = make_head()
    ...
    def forward(self, img):
        ...
        Total = self.softplus(self.head_total(feat))
        r_gdm = self.sigmoid(self.head_gdm_ratio(feat))
        r_clover = self.sigmoid(self.head_clover_ratio(feat))
